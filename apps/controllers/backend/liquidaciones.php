...
class Liquidaciones extends CI_Controller {
    ...
    function index() {
        $datos ['content'] = 'backend/liquidaciones/listar'; // llamada al content de este metodo
        $datos ['hide'] = false;
        $datos ['seccion'] = array(
            'Liquidaciones',
            'bo/liquidaciones',
            'Listado',
            'bo/liquidaciones/Listar'
        );
    ...
    function Agregar() {
        $datos ['content'] = 'backend/liquidaciones/index'; // llamada al content de este metodo
        $datos ['hide'] = false;
        $datos ['seccion'] = array(
            'Liquidaciones',
            'bo/liquidaciones',
