...
class Noticias extends CI_Controller {
    ...
    protected $subcategoria = 'noticias-internas';
    ...
    public function index2($pag = 1) {
        ...
        $datos['content'] = '/frontend/noticias/index';
        $datos['titulo'] = "Caren";
    ...
    function index($page = 0) {
        ...
        $this->paginacion->Uri = base_url() . "bienestar/noticias-internas/";
    ...
    public function details($param) {
        ...
        $datos['content'] = '/frontend/noticias/detalle';
        $datos['titulo'] = "Caren";
        $this->load->view('frontend/layout', $datos); // llamada a la vista general*/
    }
