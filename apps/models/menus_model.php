...
class Menus_Model extends CI_Model {
    ...
    protected $table = 'in_menu';
    //protected $subtable = 'in_sub_categoria_temas';

    function __construct() {
        parent::__construct();
    }
    // recupera las cate gorias
    function ListarMenusById($idMenu) {
        $this->db
    ...
    function InsertarNuevoMenu($data=null){
	   if (is_array($data)) {
	   	$this->db->trans_start();
   ...
   function ActualizarMenu($data=null){
	   if (is_array($data)) {
