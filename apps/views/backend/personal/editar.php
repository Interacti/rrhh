            ...
            <div class="row-fuid">
                ...
                <div class="span3">
                    <div class="row">
                        ...
                        <img alt=""
                             src="<?php echo base_url() ?>assets/frontend/img/destacado/<?php echo $rs[0]->list_image ?>"
                             class="img-polaroid">
                    </div>
                    <div class="row">
                        <h5>Imagen principal se ocupa como cabecera del detalle</h5>
                        <img alt=""
                             src="<?php echo base_url() ?>assets/frontend/img/destacado/<?php echo $rs[0]->feature_image ?>"
                             class="img-polaroid">
                    </div>
