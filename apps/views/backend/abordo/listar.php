...
<div class="row-fluid">
	<div class="panel panel-security">
        ...
        <?php endif ?>
		 ...
		 <div class="row-fuid">
        	...
        	<a href="<?php echo BASE_URL ?>bo/abordo/Agregar" class="btn btn-primary btn-small">
                    <i class="icon-plus-sign icon-white"></i> 
                     Agregar Nuevos Abordo
            </a>
	...
	<tbody>
                ...
                <tr>
                    ...
                    <div class="btn-group">
                            <?php if  ($ls->status==0){ ?>
    						<a class="btn btn-small btn-danger" href="<?php echo BASE_URL ?>bo/abordo/Activar/<?php echo $ls->id?>">
                                <i class="icon-ok" title="Activar"></i> Activar&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            </a>    

                            <?php }else{ ?>
                            <a class="btn btn-small btn-success " href="<?php echo BASE_URL ?>bo/abordo/Desactivar/<?php echo $ls->id?>">
                            <i class="icon-ban-circle " title="Desactivar"></i> Desactivar
                            <?php } ?>
                            </a>
                        <a class="btn btn-small btn-success" href="<?php echo BASE_URL ?>bo/abordo/Editar/<?php echo $ls->id?>">
                            <i class="icon-edit" title="Editar"></i> Editar
                        </a>
                        <a class="btn btn-small btn-danger" href="<?php echo BASE_URL ?>bo/abordo/Eliminar/<?php echo $ls->id?>">
