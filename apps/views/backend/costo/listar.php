...
<div class="row-fluid">
    <div class="panel panel-security">
        ...
        <div class="panel-body">
            ...
            <div class="row-fuid">
                <a href="<?php echo BASE_URL ?>bo/costo/Agregar" class="btn btn-primary btn-small">
                    <i class="icon-plus-sign icon-white"></i> 
                    Agregar Nuevo Centro Costo
                </a>
            </div>  
                            ...
                            foreach ($data as $ls) :
                                ...
                                <tr>
                                    ...
                                    <td align="right">
                                        ...
                                        <div class="btn-group">
                                            <?php if ($ls->estado == 0) { ?>
                                                <a class="btn btn-small btn-danger" href="<?php echo BASE_URL ?>bo/costo/Activar/<?php echo $ls->id ?>">
                                                    <i class="icon-ok" title="Activar"></i> Activar&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                </a>    

                                            <?php } else { ?>
                                                <a class="btn btn-small btn-success " href="<?php echo BASE_URL ?>bo/costo/Desactivar/<?php echo $ls->id ?>">
                                                    <i class="icon-ban-circle " title="Desactivar"></i> Desactivar
                                                <?php } ?>
                                            </a>
                                            <a class="btn btn-small btn-success" href="<?php echo BASE_URL ?>bo/costo/Editar/<?php echo $ls->id ?>">
