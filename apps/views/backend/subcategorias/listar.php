<div class="row-fluid">
	<div class="panel panel-security">
		...
		<div class="panel-body">
    		...
    		<a href="<?php echo BASE_URL ?>bo/subcategorias/Agregar" class="btn btn-primary btn-small">
	...
	<tbody>
                ...
                <tr>
                   ...
                   <div class="btn-group">
    						...
    						<a class="btn btn-small btn-success" href="<?php echo BASE_URL ?>bo/subcategorias/Editar/<?php echo $ls->id_sub_categoria?>">
                            <i class="icon-edit icon-white" title="Editar"></i> Editar</a>
    			
                   			<?php if  ($ls->estado==0){ ?>
    						<a class="btn btn-small btn-danger " href="<?php echo BASE_URL ?>bo/subcategorias/Activar/<?php echo $ls->id_sub_categoria?>/<?php echo $ls->estado?>">
                            
                            <i class="icon-ok icon-white" title="Activar"></i> Activar&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <?php }else{ ?>
                            <a class="btn btn-small btn-success " href="<?php echo BASE_URL ?>bo/subcategorias/Activar/<?php echo $ls->id_sub_categoria?>/<?php echo $ls->estado?>">
