...
<div class="row-fluid">
	<div class="panel panel-security">
        ...
        <?php endif ?>
		 ...
		 <div class="row-fuid">
        	...
        	<a href="<?php echo BASE_URL ?>bo/productos/Agregar" class="btn btn-primary btn-small">
	...
	<tbody>
                ...
                <tr>
                    ...
                    <div class="btn-group">
                            <?php if  ($ls->status==0){ ?>
    						<a class="btn btn-small btn-danger" href="<?php echo BASE_URL ?>bo/productos/Activar/<?php echo $ls->id?>">
                                <i class="icon-ok" title="Activar"></i> Activar&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            </a>    

                            <?php }else{ ?>
                            <a class="btn btn-small btn-success " href="<?php echo BASE_URL ?>bo/productos/Desactivar/<?php echo $ls->id?>">
                        ...
                        <a class="btn btn-small btn-danger" href="<?php echo BASE_URL ?>bo/productos/Eliminar/<?php echo $ls->id?>">
