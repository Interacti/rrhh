...
<head>
        ...
        <script type="text/javascript" src="http://www.rutaparaiso.cl/assets/backoffice/js/highcharts/js/highcharts.js"></script>
</head>
<body>
        <div id="menu" class="left">
                <ol>
                        <li><?php echo anchor('bo/'.$home.'basic example')?></li>
                        <li><?php echo anchor($home.'categories', 'Advanced example')?></li>
                        <li><?php echo anchor($home.'template', 'Options from template file')?></li>
                        <li><?php echo anchor('bo/grafico/'.'active_record', 'multiples chart and Database result')?></li>
                        <li><?php echo anchor('bo/'.$home.'pie', 'Pie grah with callback functions')?></li>
                        <li><?php echo anchor('bo/'.$home.'data_get', 'outputing json or array')?></li>
                </ol>
        </div>

        <div id="g_render" class="left" style="width:600px ;">
