<div class="row-fluid">
    <div class="panel panel-security">
        ...
        <div class="panel-body">
            ...
            <?php endif ?>
            <div class="row-fuid">
                <a href="<?php echo BASE_URL ?>bo/galeria/Agregar" class="btn btn-primary btn-small">
                            ...
                            foreach ($data as $ls) :
                                ...
                                <tr>
                                    ...
                                    <td align="right">
                                        <div class="btn-group">
                                            <?php if ($ls->status == 0) { ?>
                                            <a class="btn btn-small btn-danger" href="<?php echo BASE_URL ?>bo/galeria/Activar/<?php echo $ls->id ?>">
                                                <i class="icon-ok" title="Activar"></i> Activar&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            </a>    

                                            <?php } else { ?>
                                                <a class="btn btn-small btn-success " href="<?php echo BASE_URL ?>bo/galeria/Desactivar/<?php echo $ls->id ?>">
                                                    <i class="icon-ban-circle " title="Desactivar"></i> Desactivar
                                            <?php } ?>
                                            </a>
                                            <a class="btn btn-small btn-success" href="<?php echo BASE_URL ?>bo/galeria/Listar_Imagenes/<?php echo $ls->id ?>">
                                                <i class="icon-edit" title="Editar"></i>    Imagenes
                                            </a>
                                            <a class="btn btn-small btn-success" href="<?php echo BASE_URL ?>bo/galeria/Editar/<?php echo $ls->id ?>">
