    ...
    <div class="panel panel-security">
        ...
        <div class="panel-body">
            <div class="row-fuid">
                                ...
                                <div class="controls">
                                    <div data-date-format="yyyy-mm-dd" data-date="" id="dp3"
                                        ...
                                        <input type="text" readonly fecha_inicio size="16"
                                               ...
                                               value="<?php echo isset($myFormData['fecha_evento']) ? $myFormData['fecha_evento'] : date('Y-m-d',strtotime($rs[0]->event_date)); ?> " 
                                               /> <span
                ...
                <div class="span3">
                    <div class="row">
                        <h5>Imagen Miniatura ocupada para el listado</h5>
                        <img alt=""
                             src="<?php echo base_url() ?>assets/frontend/img/charlas/<?php echo $rs[0]->list_image ?>"
                             class="img-polaroid">
                    </div>
                    <div class="row">
                        <h5>Imagen principal se ocupa como cabecera del detalle</h5>
                        <img alt=""
                             src="<?php echo base_url() ?>assets/frontend/img/charlas/<?php echo $rs[0]->feature_image ?>"
                             class="img-polaroid">
                    </div>

                    <div class="row">
                        <h5>Archiv Adjunto</h5>
                        <a href="<?php echo base_url() ?>assets/frontend/pdf/<?php echo $rs[0]->alternate_file ?>" target="_blank" > <i class="icon-download" title="Eliminar"></i> Descargar</a>
                    </div>
