            ...
            <div class="row-fuid">
                ...
                <div class="span7">
                    <form class="form-horizontal"
                          action="<?php echo BASE_URL ?>bo/socios/actualizar"
                        ...
                        <fieldset>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="hidden" name="hdImg1" value="<?php echo $myFormData['imagen_socio'] ?>">
                ...
                <div class="span4">
                    <h5>Banner Actual</h5>
                    <img alt="" src="<?php echo BASE_URL ?>assets/frontend/img/personal/<?php echo $myFormData['imagen_socio'] ?>" class="img-polaroid">
                </div>
            </div>
        </div>
    </div>
