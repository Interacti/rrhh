    ...
    <div class="panel panel-security">
        ...
        <div class="panel-body">
            <div class="row-fuid">
                                ...
                                <div class="controls">
                                    <select id="categoria" name="categoria" class="input-xlarge">
                                        ...
                                        <?php foreach ($categorias as $categoria) : ?>
                                            <option value="<?php echo $categoria->id  ?>" <?php echo ($categoria->id == $rs[0]->category) ? 'selected' : '' ?>  > <?php echo $categoria->title ?> </option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
                ...
                <div class="span3">
                    <div class="row">
                        <h5>Imagen Miniatura ocupada para el listado de beneficios</h5>
                        <img alt=""
                             src="<?php echo base_url() ?>assets/frontend/img/beneficios/<?php echo $rs[0]->list_image ?>"
                             class="img-polaroid">
                    </div>
                    <div class="row">
                        <h5>Imagen principal se ocupa como cabecera del detalle de la noticia</h5>
                        <img alt=""
                             src="<?php echo base_url() ?>assets/frontend/img/beneficios/<?php echo $rs[0]->feature_image ?>"
                             class="img-polaroid">
                    </div>

                    <div class="row">
                        <h5>Archiv Adjunto</h5>
                        <a href="<?php echo base_url() ?>assets/frontend/img/beneficios/<?php echo $rs[0]->feature_image ?>" target="_blank" > <i class="icon-download" title="Eliminar"></i> Descargar</a>
                    </div>
