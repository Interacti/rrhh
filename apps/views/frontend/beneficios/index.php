                    ...
                    <div class="col-md-12 no-padding">
                        <?php foreach ($info->Data as $in): ?>
                            <div class="col-md-12 noticias-bienestar-box"  >
                                <div class="col-md-3 no-padding"> <img src="<?php echo LIST_IMAGE . 'beneficios/' . $in->list_image ?>"  tr class="img-responsive" alt=""> </div>
                                <div class="col-md-9" >
                                    ...
                                    <?php if (have_parent($in->id)) : ?>
                                    <div class="col-md-12 m-t-70" style="margin-top: 70px"  >
                                        <a  href="<?php echo base_url() . '' . strtolower($categoria) . '/' . strtolower($subcategoria) . '/detalle/' . $in->id ?>"   type="button" class="btn btn-large btn-block btn-primary">Ver Covenios</a>
                                    </div>
                                    <?php endif; ?>
                                </div>
                            </div>
