            ...
            <div class="col-md-9 " >
                <div class="col-md-12">
                    <h2 class="titulo-destacado-inc">
                        <strong>
                            <?php echo ucfirst(strtolower($categoria)); ?> / <?php echo ucfirst(strtolower('Prevencion de riesgos')); ?> 
                        </strong>
                    </h2> 
                </div>	
                    ...
                    <div class="col-md-12 no-padding">
                        <?php foreach ($info->Data as $in): ?>
                            <div class="col-md-12 noticias-bienestar-box"   >
                                <div class="col-md-3 no-padding"> <img src="<?php echo LIST_IMAGE . 'concurso/' . $in->list_image ?>"  tr class="img-responsive" alt=""> </div>
                                <div class="col-md-9" >
                                    <div class="col-md-12 noticias-bienestar-title" style="color: #94c120;" ><?php echo $in->title ?></div>
